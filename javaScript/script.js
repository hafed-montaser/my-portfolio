...
btm2.onmouseenter = function() {
  read2.classList.add("sohaw-read-more2");
};
btm2.onmouseleave = function() {
  read2.classList.remove("sohaw-read-more2");
};
btm3.onmouseenter = function() {
  read3.classList.add("sohaw-read-more3");
};
btm3.onmouseleave = function() {
  read3.classList.remove("sohaw-read-more3");
};
...
ScrollReveal().reveal(".image-home, .heading", {
  origin: `top`
});
ScrollReveal().reveal(" .cont-serv, .content-skills, .conact-me form", {
  origin: `bottom`
});
